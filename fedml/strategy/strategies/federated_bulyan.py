...
from .aggregate import aggregate_krum, aggregate_bulyan
...
class FederatedBulyan(FederatedAverage):
    ...
    def aggregate_fit(
        ...
        parameters_aggregated = aggregate_bulyan(weights_results, self.num_malicious_clients, self.first_aggregation_rule, **self.aggregation_rule_kwargs)
