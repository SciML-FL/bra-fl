...
from .aggregate import aggregate_bucketing
...
class FederatedBucketing(FederatedAverage):
    ...
    def aggregate_fit(
        ...
        parameters_aggregated = aggregate_bucketing(weights_results, self.num_malicious_clients, self.num_clients_to_keep)
